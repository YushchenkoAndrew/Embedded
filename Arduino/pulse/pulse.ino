...
void setup() {
  pinMode(LED13,OUTPUT);         // pin that will blink to your heartbeat!
   Serial.begin(19200);         // Set's up Serial Communication at certain speed. 
...
for (int i=1; i<=3; i++)
{
  ...
  Signal=Signal+analogRead(PulseSensorPurplePin);// Read the PulseSensor's value. 
}                                            // Assign this value to the "Signal" variable.

   Serial.println(Signal/3);                    // Send the Signal value to Serial Plotter.
